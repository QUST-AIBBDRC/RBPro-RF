...
data_train = sio.loadmat(r'D:\FA.mat')
X=data_train.get('X')
data_train = sio.loadmat(r'D:\y.mat')
datay=data_train.get('y')
y=datay
sepscores = []
...
for train, test in skf.split(X,y): 
    ...
    print('FA:acc=%f,precision=%f,npv=%f,sensitivity=%f,specificity=%f,mcc=%f,f1=%f,roc_auc=%f'
...
yscore_sum.to_csv('FAyscore_sum.csv')
ytest=ytest[np.array(range(1,row)),:]
ytest_sum = pd.DataFrame(data=ytest)
ytest_sum.to_csv('FAytest_sum.csv')
