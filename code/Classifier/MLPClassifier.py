...
yscore_sum.to_csv('MLyscore_sum.csv')
ytest=ytest[np.array(range(1,row)),:]
ytest_sum = pd.DataFrame(data=ytest)
ytest_sum.to_csv('MLytest_sum.csv')
scores_sum = pd.DataFrame(data=scores)
scores_sum.to_csv('MLscores.csv')
...
#data_csv.to_csv('RBP-test_rf_S＿Ｌ.csv')