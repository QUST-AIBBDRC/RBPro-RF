...
cv_clf =SVC(C=0.0000001,kernel='linear',probability=True,gamma=10000)
...
yscore_sum.to_csv('SVMyscore_sum13.csv')
ytest=ytest[np.array(range(1,row)),:]
ytest_sum = pd.DataFrame(data=ytest)
ytest_sum.to_csv('SVMytest_sum13.csv')
...
data_csv.to_csv('SVMresult13.csv')
